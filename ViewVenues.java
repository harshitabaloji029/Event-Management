...
public class ViewVenues extends JFrame{
    ...
    ViewVenues(){
        ...
        for(int i = 0 ; i <= 9; i++){
            image[i] = new ImageIcon(ClassLoader.getSystemResource("event/management/system/icons/"+(i+1)+".jpg"));
...
import java.awt.Image;
import javax.swing.*;
public class ViewVenues extends JFrame implements Runnable{
    Thread t1;
    JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l10;
    JLabel[] label = new JLabel[]{l1,l2,l3,l4,l5,l6,l7,l8,l9,l10};
    JLabel caption;
    public void run(){
        String[] text = new String[]{"Shagun","THE FERN","Planet Hollywood","Goan Heritage","JW Marriot","Irish House","Wada","Nidhi's Lawn","Harshita's Lawn","Aditi's Lawn"};
    ...
    ViewVenues(){
        ...
        image[i]  = new ImageIcon(ClassLoader.getSystemResource("event/management/system/icons/v1.jpg"));
        jimage[i] = image[i].getImage().getScaledInstance(900, 700,Image.SCALE_DEFAULT);
        iimage[i] = new ImageIcon(jimage[i]);
        this.label[i] =new JLabel(iimage[i]);
        this.label[i].setBounds(0,0,900,700);
