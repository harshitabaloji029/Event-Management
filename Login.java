...
public class Login extends JFrame implements ActionListener {
    ...
    Login(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("event/management/system/icons/login.png"));
        ...
        p2.setLayout(null);
        p2.setBounds(250,30,410,310);
        add(p2);
        
        JLabel l2 = new JLabel("Username");
        l2.setBounds(80,20,100,25);
        l2.setFont(new Font("SAN_SERIF",Font.PLAIN, 20));
        p2.add(l2);
        t1 = new JTextField();
        t1.setBounds(80,60,250,30);
