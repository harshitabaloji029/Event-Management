...
public class BookPackage extends JFrame implements ActionListener{
    ...
    BookPackage(String username){
        ...
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("event/management/system/icons/wedding1.jpg"));
        Image i2 = i1.getImage().getScaledInstance(500, 300,Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2);
        JLabel l16 =new JLabel(i3);
        l16.setBounds(500,50,500,300);
        add(l16);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b1){
            ...
            int cost = 0;
            if(p.equals("Lawn Party")){
                cost+=38000;
            }else if(p.equals("Banquet Party")){
                cost+=72000;
            }
