...
public class DeleteCustomer extends JFrame implements ActionListener{
    ...
    DeleteCustomer(String user){
        ...
        try{
            ...
            ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("event/management/system/icons/delete.png"));
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b1){
            try{
                ...
                c.s.executeUpdate("delete from bookvenue where username = '"+username+"'");
