...
public class UpdateCustomer extends JFrame implements ActionListener{
    JTextField t1,t2,t3,t5,t6,t7,t4,t8,t9;
    JComboBox c1;
    JRadioButton r1,r2;
    JButton b1,b2;
    UpdateCustomer(String username){
        ...
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("event/management/system/icons/update.png"));
        Image i2 = i1.getImage().getScaledInstance(300, 290,Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2);
        JLabel l10 = new JLabel(i3);
        l10.setBounds(450,80,250,300);
        add(l10);
