...
public class ViewBookedVenue extends JFrame implements ActionListener {
    JButton b1;
    ViewBookedVenue(String username){
        setBounds(320,200,920,550);
        setLayout(null);
        getContentPane().setBackground(Color.WHITE);
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("event/management/system/icons/lawn.jpg"));
        Image i2 = i1.getImage().getScaledInstance(600, 500,Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2);
        JLabel l30 =new JLabel(i3);
        l30.setBounds(450,30,450,400);
        add(l30);
        JLabel heading = new JLabel("VIEW BOOKED VENUE");
        ...
        add(l11);
        JLabel l2 = new JLabel("Venue Name: ");
        ...
        try{
            Conn c = new Conn();
            ResultSet rs = c.s.executeQuery("select * from bookvenue where username = '"+username+"'");
            while(rs.next()){
    ...
    public static void main(String[] args){
        new ViewBookedVenue("").setVisible(true);
    }
}
